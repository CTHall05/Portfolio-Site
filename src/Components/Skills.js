  ...
  return (
    <section className='skills-container'>
      <div className="skill-description-card">
        <h2>Skills I Have:</h2>
        <p>I am proficient in HTML and CSS, I am continueing to improve my programming skills with JavaScript and Typescript</p>
        <p>Foccusing on the React framework, I aim to create beautiful projects and quickly</p>
      </div>
